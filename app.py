...
for k, v in {
    "pos": [], "inventory": {}, "transfers": [], "shopify_orders": []
}.items():
...
st.divider()
st.caption("🧪 **Modo prueba activo** — Los botones de Shopify muestran el payload que se enviaría al API. Ningún dato real es modificado.")
